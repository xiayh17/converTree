...
The goal of converTree is to convert tree format among newick, parent vector and 
ancestor matrix.
...
Functions of these module using Rcpp that convert tree format
is a interface of R for code from https://github.com/cbg-ethz/infSCITE.
